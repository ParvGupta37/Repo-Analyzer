...
class GitHubService:
        ...
        async def fetch():
            ...
            async with httpx.AsyncClient(timeout=30.0, verify=False) as client:
                try:
                    ...
                    raise ValueError(
                        f"Failed to connect to GitHub: Connection error. Check your internet connection."
                    )
                except httpx.TimeoutException as e:
                    raise ValueError(
                        f"Failed to connect to GitHub: Request timed out. Check your internet connection."
                    )
    ...
    async def get_issues(
        self, owner: str, repo: str, state: str = "open", max_issues: int = 50
    ) -> List[Dict]:
